...
public final class Product implements Model {
  ...
  private Product(String id, String name, String description, Temporal.DateTime dateCreated, String productCategory) {
    this.id = id;
    this.name = name;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, String description, Temporal.DateTime dateCreated, String productCategory) {
      super.id(id);
      super.name(name)
