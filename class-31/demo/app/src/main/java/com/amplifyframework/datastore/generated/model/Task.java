...
public final class Task implements Model {
  ...
  private Task(String id, String title, String description, String status, String name) {
    this.id = id;
    this.title = title;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String title, String description, String status, String name) {
      super.id(id);
      super.title(title)
